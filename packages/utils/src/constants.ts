...
export const ENTITIES_PORT = Number(process.env.ENTITIES_PORT ?? 5000)
export const ADOPTIONS_PORT = Number(process.env.ADOPTIONS_PORT ?? 6000)
export const MEDIA_PORT = Number(process.env.MEDIA_PORT ?? 7000)
export const WEB_PORT = Number(process.env.WEB_PORT ?? 8000)
...
export const MAIL_USER = process.env.EMAIL_USER // Cambiado para usar EMAIL_USER del .env
export const MAIL_PASS = process.env.EMAIL_PASS // Cambiado para usar EMAIL_PASS del .env
