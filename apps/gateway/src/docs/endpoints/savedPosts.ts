...
const SavedPostSchema = z.object({
    ...
    post: z
        .object({
            ...
            description: z.string().describe("Descripción de la publicación"),
            status: z.string().describe("Estado de la publicación"),
            createdat: z.string().describe("Fecha de creación"),
            updatedat: z.string().nullable().describe("Fecha de actualización"),
            creatorid: z.number().describe("ID del creador de la publicación"),
            petid: z.number().nullable().describe("ID de la mascota"),
            pet: z
                .object({
                    id: z.number(),
