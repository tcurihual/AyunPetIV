...
export default function DeletionSuccessScreen() {
    ...
    useEffect(() => {
        ...
        iconRotation.value = withSpring(0, { damping: 10, stiffness: 80 })
    ...
    const handleViewPublications = () => {
        router.replace("/(shelter)/publication/all-publications")
    }
            ...
            <View style={styles.container}>
                ...
                <View style={styles.topContent}>
                    ...
                    <Animated.View style={[styles.textContainer, contentAnimatedStyle]}>
                        <Text style={styles.title}>¡Publicación Eliminada! ✅</Text>
                        {petName && (
                            <Text style={styles.subtitle}>
                                La publicación de "{petName}" ha sido eliminada correctamente
                            </Text>
                        )}
                    </Animated.View>
                </View>
