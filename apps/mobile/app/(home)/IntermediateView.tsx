  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>Así podremos recomendarte adopciones más acertadas</Text>

        {/* Chips tipo de mascota */}
        <Section title="¿Qué te interesa adoptar?">
          <ChipRow>
            <Chip label="Perro" icon="🐕" active={petType === "dog"} onPress={() => setPetType("dog")} />
            <Chip label="Gato" icon="🐱" active={petType === "cat"} onPress={() => setPetType("cat")} />
            <Chip label="Ambos" icon="✨" active={petType === "both"} onPress={() => setPetType("both")} />
          </ChipRow>
        </Section>
        ...
        <Section title="Género">
          <ChipRow>
            <Chip label="Cualquiera" active={gender === "any"} onPress={() => setGender("any")} />
            <Chip label="Macho" active={gender === "male"} onPress={() => setGender("male")} />
            <Chip label="Hembra" active={gender === "female"} onPress={() => setGender("female")} />
          </ChipRow>
        </Section>
        ...
        <Section title="Edad">
          <ChipRow>
            <Chip label="Cualquiera" active={age === "any"} onPress={() => setAge("any")} />
            <Chip label="Cachorro/a" active={age === "puppy"} onPress={() => setAge("puppy")} />
            <Chip label="Joven" active={age === "young"} onPress={() => setAge("young")} />
            <Chip label="Adulto" active={age === "adult"} onPress={() => setAge("adult")} />
            <Chip label="Senior" active={age === "senior"} onPress={() => setAge("senior")} />
          </ChipRow>
        </Section>
        ...
        <Section title="Tamaño">
          <ChipRow>
            <Chip label="Cualquiera" active={size === "any"} onPress={() => setSize("any")} />
            <Chip label="Pequeño" active={size === "small"} onPress={() => setSize("small")} />
            <Chip label="Mediano" active={size === "medium"} onPress={() => setSize("medium")} />
            <Chip label="Grande" active={size === "large"} onPress={() => setSize("large")} />
          </ChipRow>
        </Section>
        ...
        <Section title="Distancia máxima">
          <ChipRow>
            <Chip label="Cualquiera" active={distance === "any"} onPress={() => setDistance("any")} />
            <Chip label="5 km" active={distance === "5"} onPress={() => setDistance("5")} />
            <Chip label="10 km" active={distance === "10"} onPress={() => setDistance("10")} />
            <Chip label="25 km" active={distance === "25"} onPress={() => setDistance("25")} />
          </ChipRow>
        </Section>
        ...
        <Section title="Compatibilidad en el hogar">
          <View style={styles.card}>
            ...
            <ChipRow>
              <Chip label="Sí" active={kidsOk === true} onPress={() => setKidsOk(true)} />
              <Chip label="No" active={kidsOk === false} onPress={() => setKidsOk(false)} />
              <Chip label="Indistinto" active={kidsOk === null} onPress={() => setKidsOk(null)} />
            </ChipRow>

            <View style={{ height: 10 }} />
            <Text style={styles.cardLabel}>¿Hay otras mascotas?</Text>
            <ChipRow>
              <Chip label="Sí" active={otherPetsOk === true} onPress={() => setOtherPetsOk(true)} />
              <Chip label="No" active={otherPetsOk === false} onPress={() => setOtherPetsOk(false)} />
              <Chip label="Indistinto" active={otherPetsOk === null} onPress={() => setOtherPetsOk(null)} />
            </ChipRow>
          </View>
        </Section>
