...
// Mock data basado en la captura
const mockPets: Pet[] = [
    {
        id: "1",
        name: "Firulais",
...
export default function Home() {
    ...
    const filteredPets = mockPets.filter((pet) => {
        ...
        // Para el filtro de edad, podríamos agregar más lógica específica aquí
        return true
    })

    const handleApplyFilters = (filters: FilterOptions) => {
        setActiveFilters(filters)
        // Si hay filtros del modal activos, resetear el filtro rápido
        if (filters.type !== "all") {
...
const styles = StyleSheet.create({
    container: {
        flex: 1,
        marginTop: 16,
        //backgroundColor: "#F9C80E", // Fondo amarillo similar a la captura
        backgroundColor: "#fff",
    },
    categoriesSection: {
    ...
    cardContainer: {
        flex: 1,
        maxWidth: (width - 48) / 2, // Para 2 columnas con espaciado
        marginBottom: 16,
        backgroundColor: "#fff",
    },
})
