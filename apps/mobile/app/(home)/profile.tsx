...
export default function GiverProfileScreen() {
  ...
  const activePosts: Post[] = [
    { id: "p1", name: "Firulais", ageGender: "Macho adulto", imageUrl: "https://place-puppy.com/300x300" },
    { id: "p2", name: "Pelusa", ageGender: "Hembra adulta", imageUrl: "https://placekitten.com/300/300" },
    { id: "p3", name: "Bola de Nieve", ageGender: "Hembra cachorro", imageUrl: "https://placekitten.com/301/301" },
    { id: "p4", name: "Ayudante de Santa", ageGender: "Macho joven", imageUrl: "https://place-puppy.com/301x301" },
  ]
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 24 }}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.name}>
            {giver.isFoundation && giver.foundationName ? giver.foundationName : giver.displayName}
          </Text>
          ...
          {giver.isFoundation ? <Text style={styles.badge}>Fundación</Text> : <Text style={styles.badge}>Dador</Text>}
        </View>
        <TouchableOpacity style={styles.logoutPill} onPress={handleLogout} disabled={status === "loading"}>
      ...
      <View style={styles.statsRow}>
        ...
        <View style={styles.statCard}>
          <Text style={styles.statNum}>{giver.metrics?.rating ? `⭐ ${giver.metrics.rating}` : "⭐ -"}</Text>
      ...
      {activePosts.length === 0 ? (
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptyText}>Este dador no tiene mascotas en adopción actualmente.</Text>
        </View>
      ) : (
