...
import RequestDetailCard, { Status } from "@/components/RequestDetailCard";
...
export default function RequestDetail() {
  ...
  if (!solicitud) {
    return <View><BottomNavbar activeTab="requests" onTabPress={() => {}} /></View>;
  }
    ...
    <View style={{ flex: 1, backgroundColor: "#F2F2F2" }}>
      ...
      <BottomNavbar
        ...
        onTabPress={(tab) => {
          ...
          if (tab === "requests") return router.push("./requestsList");
