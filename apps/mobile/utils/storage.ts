...
const PREFS_DONE_KEY = "prefs_done" // <-- NUEVO
...
export async function clearAuth() {
  await Promise.all([
    ...
    AsyncStorage.removeItem(PREFS_DONE_KEY), // opcional: limpiar también el flag
  ])
}

/** Marca que el usuario YA completó la vista intermedia de preferencias */
...
/* --- Tus funciones “first launch” pueden quedarse si las usas en otro lado --- */
